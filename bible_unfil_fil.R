...
decadeFig <- ggplot(numbersBibFilter, aes(colour=as.character(differenceG))) + geom_segment(aes(x=1, xend=2, y=posUnfil, yend=posFil))
print(decadeFig)

file <- paste("C:/Users/mikko/OneDrive/Työpöytä/Gradu/masters_thesis_spectator/graphs/", currentEdition, "/bib_unfil_fil.png", sep="")
