...
file <- paste("C:/Users/mikko/OneDrive/Työpöytä/Gradu/masters_thesis_spectator/graphs/", currentEdition, "/pl_comparison_decade_index.png", sep="")
...
pl_spec_uses <- paradise_filtered %>% filter(estc_id %in% pure_vector)
...
pl_decades_fig <- ggplot() +
  geom_line(data = pl_cluster_decades, aes(x=publication_decade, y=percentage_n)) 
...
file <- paste("C:/Users/mikko/OneDrive/Työpöytä/Gradu/masters_thesis_spectator/graphs/", currentEdition, "/pl_decades.png", sep="")
png(file=file,width=1200, height=700)
print(pl_decades_fig)
dev.off()

file <- paste("C:/Users/mikko/OneDrive/Työpöytä/Gradu/masters_thesis_spectator/graphs/", currentEdition, "/pl_cluster_decades.png", sep="")
png(file=file,width=1200, height=700)
print(pl_entries_with_cluster_decades_fig)
dev.off()
